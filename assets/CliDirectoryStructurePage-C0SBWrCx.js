...
└── .session-info.json           # Session metadata`)])],-1)),e[10]||(e[10]=t("p",null,[r("Async-Profiler creates new chunks based on the "),t("code",null,"loop"),r(" and "),t("code",null,"chunksize"),r(" parameters. The "),t("code",null,"%t"),r(" placeholder in the file pattern is replaced with the current timestamp.")],-1)),o(s,{type:"info"},{default:n(()=>[...e[1]||(e[1]=[t("strong",null,"Additional files:",-1),r(),t("code",null,"perf-counters.hsperfdata",-1),r(" (HotSpot Performance Counters) and ",-1),t("code",null,"hs-jvm-err.log",-1),r(" (HotSpot JVM Error Log) are artifact files that can be viewed in the session details. The presence of ",-1),t("code",null,"hs-jvm-err.log",-1),r(" indicates a JVM crash was detected. ",-1)])]),_:1}),e[11]||(e[11]=m(`<h2 id="streaming-repository" data-v-44ab3390>Streaming Repository</h2><p data-v-44ab3390>When <code data-v-44ab3390>messaging</code> is enabled, an additional <code data-v-44ab3390>streaming-repo/</code> subdirectory is created for JDK&#39;s JFR streaming repository:</p><div class="directory-structure" data-v-44ab3390><pre data-v-44ab3390><code data-v-44ab3390>&lt;session-id&gt;/
...
└── .session-info.json</code></pre></div><p data-v-44ab3390>The streaming repository serves two purposes:</p><ul data-v-44ab3390><li data-v-44ab3390><strong data-v-44ab3390>Heartbeat events</strong> - Periodic liveness signals emitted by the Jeffrey Agent, used by the platform to detect when sessions finish</li><li data-v-44ab3390><strong data-v-44ab3390>Application events</strong> - Messages and alerts emitted by the application for real-time processing</li></ul><p data-v-44ab3390>Unlike Async-Profiler files which are written periodically, streaming events are captured in real-time and stored in the JDK&#39;s native repository format.</p>`,6)),o(s,{type:"info"},{default:n(()=>[...e[2]||(e[2]=[t("strong",null,"Two recording mechanisms:",-1),r(" Async-Profiler generates high-performance profiling data (CPU, allocation, lock) while the JDK streaming repository captures Heartbeat, Message, and Alert events. Both coexist in the same session directory. ",-1)])]),_:1})]),o(l)]))}}),H=y(b,[["__scopeId","data-v-44ab3390"]]);export{H as default};
