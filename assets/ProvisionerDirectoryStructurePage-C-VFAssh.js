import{D as s}from"./DocsCallout-C5N5WHD2.js";import{D as d}from"./DocsNavFooter-CW98DusR.js";import{D as l}from"./DocsPageHeader-BLKeW_ND.js";import{u as p}from"./useDocHeadings-ALrAs1tK.js";import{i as c,o as f,e as u,h as o,a as t,g as r,B as n,f as m,m as g}from"./index-nQy9Ciy5.js";import{_ as y}from"./_plugin-vue_export-helper-DlAUqK2U.js";const h={class:"docs-article"},v={class:"docs-content"},j=c({__name:"ProvisionerDirectoryStructurePage",setup(k){const{setHeadings:i}=p(),a=[{id:"jeffrey-home-structure",text:"Jeffrey Home Structure",level:2},{id:"session-directory",text:"Session Directory",level:2},{id:"streaming-repository",text:"Streaming Repository",level:2}];return f(()=>{i(a)}),(w,e)=>(g(),u("article",h,[o(l,{title:"Directory Structure",icon:"bi bi-folder-fill"}),t("div",v,[e[3]||(e[3]=t("p",null,"Jeffrey Provisioner creates a well-organized directory structure for storing profiling data. Understanding this structure helps with troubleshooting and managing disk space.",-1)),e[4]||(e[4]=t("h2",{id:"jeffrey-home-structure"},"Jeffrey Home Structure",-1)),e[5]||(e[5]=t("p",null,[r("The "),t("code",null,"jeffrey-home"),r(" directory (configured in your provisioner config) contains all Jeffrey data organized by workspaces and projects:")],-1)),e[6]||(e[6]=t("div",{class:"directory-structure"},[t("pre",null,[t("code",null,`<jeffrey-home>/
└── workspaces/
    └── <workspace-id>/
...
└── .session-info.json           # Session metadata`)])],-1)),e[10]||(e[10]=t("p",null,[r("Async-Profiler creates new chunks based on the "),t("code",null,"loop"),r(" and "),t("code",null,"chunksize"),r(" parameters. The "),t("code",null,"%t"),r(" placeholder in the file pattern is replaced with the current timestamp.")],-1)),o(s,{type:"info"},{default:n(()=>[...e[1]||(e[1]=[t("strong",null,"Additional files:",-1),r(),t("code",null,"perf-counters.hsperfdata",-1),r(" (HotSpot Performance Counters) and ",-1),t("code",null,"hs-jvm-err.log",-1),r(" (HotSpot JVM Error Log) are artifact files that can be viewed in the session details. The presence of ",-1),t("code",null,"hs-jvm-err.log",-1),r(" indicates a JVM crash was detected. ",-1)])]),_:1}),e[11]||(e[11]=m(`<h2 id="streaming-repository" data-v-81070988>Streaming Repository</h2><p data-v-81070988>When <code data-v-81070988>messaging</code> is enabled, an additional <code data-v-81070988>streaming-repo/</code> subdirectory is created for JDK&#39;s JFR streaming repository:</p><div class="directory-structure" data-v-81070988><pre data-v-81070988><code data-v-81070988>&lt;session-id&gt;/
...
└── .session-info.json</code></pre></div><p data-v-81070988>The streaming repository serves two purposes:</p><ul data-v-81070988><li data-v-81070988><strong data-v-81070988>Heartbeat events</strong> - Periodic liveness signals emitted by the Jeffrey Agent, used by the platform to detect when sessions finish</li><li data-v-81070988><strong data-v-81070988>Application events</strong> - Messages and alerts emitted by the application for real-time processing</li></ul><p data-v-81070988>Unlike Async-Profiler files which are written periodically, streaming events are captured in real-time and stored in the JDK&#39;s native repository format.</p>`,6)),o(s,{type:"info"},{default:n(()=>[...e[2]||(e[2]=[t("strong",null,"Two recording mechanisms:",-1),r(" Async-Profiler generates high-performance profiling data (CPU, allocation, lock) while the JDK streaming repository captures Heartbeat, Message, and Alert events. Both coexist in the same session directory. ",-1)])]),_:1})]),o(d)]))}}),x=y(j,[["__scopeId","data-v-81070988"]]);export{x as default};
